...
**Platform support** iOS 8.0+, iPadOS 8.0+, macOS 10.10+, tvOS 9.0+, watchOS 2.0+, ios-visionOS 1.0+
...
**Skills**: ios-app-intents-ref, ios-app-discoverability, ios-app-shortcuts-ref
