...
description: Use when creating algorithmic or generative visual artifacts in code (for example p5.js), with seeded variation and process-driven composition.
