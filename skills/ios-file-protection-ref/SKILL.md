...
- `cloud-sync` — Storage location and sync trade-offs
- `swiftdata` — Persistence considerations with file protection
- `privacy-ux` — Privacy implications and Required Reason APIs
