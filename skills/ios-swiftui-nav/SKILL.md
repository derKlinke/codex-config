...
mcp:
  ...
  related: [swiftui-layout, swiftui-performance]
---
...
- Use `swiftui-layout` for layout issues inside navigation containers
- Use `swiftui-liquid-glass` for iOS 26 navigation appearance updates
...
**Skills**: swiftui-nav, swiftui-layout
