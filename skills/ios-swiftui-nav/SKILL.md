...
#### Related Skills
- Use `ios-swiftui-nav-diag` for systematic troubleshooting of navigation failures
- Use `ios-swiftui-nav-ref` for comprehensive API reference (including Tab customization, iOS 26+ features) with all WWDC examples
...
**Skills**: ios-swiftui-nav-diag, ios-swiftui-nav-ref
