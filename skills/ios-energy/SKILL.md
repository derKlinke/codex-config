...
mcp:
  ...
  related: [swift-performance, networking, core-location]
---
...
- `core-location` — Location accuracy vs battery trade-offs
- `swift-performance` — CPU/memory optimization patterns
- `swiftui-performance` — UI/rendering energy hotspots
