...
API reference for iOS energy optimization with WWDC and Apple documentation examples.

**Related skills**: `ios-energy` (patterns), `ios-energy-diag` (troubleshooting)
