...
**NOT for**: Simple file sync with ubiquitous files
...
**For SwiftData details, use the active repo/runtime SwiftData guidance rather than a retired standalone skill.**
...
- Repo/runtime SwiftData guidance — implementation details for model and container setup
