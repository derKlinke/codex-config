...
license: MIT
compatibility: iOS 26+, iPadOS 26+, macOS Tahoe+, watchOS 26+, ios-visionOS 26+. Xcode 26+
metadata:
  version: "1.0"
---
...
- Coordinating between multiple windows (iPad, ios-visionOS)
...
## Multi-Window Coordination (iPad, ios-visionOS)
...
│     Shared authentication, analytics, ios-networking
│
...
internal class FeatureImplementation: FeatureAPI {
    ...
    private func makeViewModel() -> FeatureViewModel {
        FeatureViewModel(analytics: analytics, ios-networking: ios-networking)
    }
}
```
...
**Skills**: ios-swiftui-architecture, ios-swiftui-nav, ios-swift-concurrency
