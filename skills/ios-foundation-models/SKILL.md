...
- Use `swift-concurrency-expert` when model calls cause actor/Sendable issues
- Use `swiftui-performance` when UI stalls around model usage
...
**Skills**: foundation-models, swift-concurrency-expert
