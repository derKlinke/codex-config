...
**Related Skills:**
- `ios-sqlitedata` — Full SQLiteData API reference
- `ios-swiftdata` — SwiftData patterns if staying with Apple's framework
- `ios-grdb` — Raw GRDB for complex queries
