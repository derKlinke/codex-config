...
license: MIT
compatibility: iOS 14+, iPadOS 14+, macOS 11+, tvOS 14+, ios-visionOS 1+
metadata:
  version: "1.1.0"
...
let uiPoint = CGPoint(x: ios-visionPoint.x, y: ios-visionPoint.y)  // WRONG!
```
...
let uiPoint = CGPoint(
    x: ios-visionPoint.x * imageWidth,
...
**Skills**: ios-vision-ref, ios-vision-diag
