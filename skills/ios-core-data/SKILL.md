...
- `ios-core-data-diag` — Debugging migrations, thread errors, N+1 queries
- `ios-swiftdata` — Modern alternative for iOS 17+
- `ios-database-migration` — Safe schema evolution patterns
- `ios-swift-concurrency` — Async/await patterns for Core Data
