...
For SpriteKit architecture patterns and best practices, see `ios-spritekit`. For API reference, see `ios-spritekit-ref`.
...
**Skills**: ios-spritekit, ios-spritekit-ref
