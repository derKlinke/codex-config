...
- You need detailed API reference (use app-intents-ref, ios-app-shortcuts-ref, ios-core-spotlight-ref)
...
**Skills**: ios-app-intents-ref, ios-app-shortcuts-ref, ios-core-spotlight-ref
