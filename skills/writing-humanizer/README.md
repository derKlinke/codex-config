...
A Codex skill that removes signs of AI-generated writing from text, making it sound more natural and human.
...
If you already have this repo cloned (or you downloaded `SKILL.md`), copy the skill file into Codex's skills directory:
...
Or ask Codex to humanize text directly:
