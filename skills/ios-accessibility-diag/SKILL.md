...
Use your repo accessibility audit tooling if available (or run manual VoiceOver/Dynamic Type checks).

# Deep diagnosis for specific issues
/skill ios-accessibility-diag
```
