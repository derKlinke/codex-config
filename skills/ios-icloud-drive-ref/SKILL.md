...
**NOT for**: Structured data with relationships (use `ios-cloudkit-ref` instead)
...
- `ios-storage` — Choose iCloud Drive vs CloudKit
- `ios-cloudkit-ref` — For structured data sync
- `ios-cloud-sync-diag` — Debug iCloud sync issues
