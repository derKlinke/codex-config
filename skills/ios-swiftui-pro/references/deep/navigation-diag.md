...
**`references/deep/navigation.md`** — Discipline-enforcing anti-patterns:
...
**`references/deep/navigation-ref.md`** — Complete API documentation:
...
**`references/swift.md`** — If MainActor issues:
