...
Discipline-enforcing reference for building layouts that respond to available space rather than device assumptions. Covers tool selection, size class limitations, iOS 26 free-form windows, and common anti-patterns.
...
**Related References**: `references/deep/layout-ref.md`, `references/deep/debugging.md`, `references/deep/ios26.md`
