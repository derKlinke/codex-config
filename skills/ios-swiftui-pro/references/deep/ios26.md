...
**Foundational search APIs**: See `references/deep/search.md`. Section covers iOS 26 refinements only.
...
- `Tab(role: .search)` — Dedicated search tab; search field replaces tab bar. See `references/deep/navigation-ref.md` Section 5.7
...
See `references/deep/search.md` for foundational `.searchable` APIs. iOS 26 adds:
...
**Cross-reference** `references/deep/performance.md` — Master the SwiftUI Instrument
...
**Cross-reference** `references/swift.md` — Swift 6 strict concurrency patterns
...
**Cross-reference** `references/deep/animation.md` — Comprehensive animation guide covering VectorArithmetic, Animatable protocol, @Animatable macro, animation types, Transaction system, and performance optimization
...
**Cross-reference** Apple App Intents docs (`/appintents`) — AttributedString for Apple Intelligence Use Model action
...
- **Layout**: Use `.safeAreaPadding()` for edge-to-edge (not `.padding()`). See `references/deep/layout.md` for full guide
...
**Related References**: `references/deep/performance.md`, `references/deep/animation.md`, `references/deep/search.md`, `references/deep/navigation-ref.md`, `references/deep/layout.md`
