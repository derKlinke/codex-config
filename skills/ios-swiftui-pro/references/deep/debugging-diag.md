...
Use when:
- **Basic troubleshooting failed** — `references/deep/debugging.md` patterns did not resolve it
...
**Cross-reference**: `references/deep/performance.md` for detailed Instruments workflows
...
**When to use**:
- Preview fails after basic fixes in `references/deep/debugging.md`
...
#### Option B: Diagnostic Protocol (This Reference)
...
**Related References**: `references/deep/debugging.md`, `references/deep/performance.md`, `references/deep/layout.md`
