...
#### Related References
- Use `references/deep/navigation-diag.md` for systematic troubleshooting of navigation failures
- Use `references/deep/navigation-ref.md` for comprehensive API reference (including Tab customization, iOS 26+ features) with all WWDC examples
...
-> This reference provides a decision tree based on device targets, content hierarchy depth, and multiplatform requirements

#### 2. "How do I navigate programmatically in SwiftUI?"
-> This reference shows NavigationPath manipulation patterns for push, pop, pop-to-root, and deep linking

#### 3. "My deep links aren't working. The app opens but shows the wrong screen."
-> This reference covers URL parsing patterns, path construction order, and timing issues with onOpenURL

#### 4. "Navigation state is lost when my app goes to background."
-> This reference demonstrates Codable NavigationPath, SceneStorage persistence, and crash-resistant restoration

#### 5. "How do I implement a coordinator pattern in SwiftUI?"
-> This reference provides Router pattern examples alongside guidance on when coordinators add value vs complexity

---

## Red Flags — Anti-Patterns to Prevent

If you're doing ANY of these, STOP and use the patterns in this reference:
...
**Related References**: `references/deep/navigation-ref.md`, `references/deep/navigation-diag.md`
