...
For state restoration, advanced URL routing, and tab-based coordination, see `references/deep/navigation.md` — Pattern 7 (Coordinator) for structure, Pattern 1b for URL-based deep linking.
