...
| 26 | Bottom-aligned search, `.searchToolbarBehavior(.minimize)`, `Tab(role: .search)`, `DefaultToolbarItem(kind: .search)` — see `references/deep/ios26.md` |
...
For iOS 26 search features (bottom-aligned, minimized toolbar, search tab role), see `references/deep/ios26.md`.
...
For bottom-aligned search, `.searchToolbarBehavior(.minimize)`, `Tab(role: .search)`, and `DefaultToolbarItem(kind: .search)`, see `references/deep/ios26.md`. These build on the foundational APIs documented here.
...
**Related References**: `references/deep/ios26.md`, `references/deep/navigation-ref.md`, `references/deep/navigation.md`
