...
API reference for SwiftUI adaptive layout tools. For decisions and anti-patterns, see `references/deep/layout.md`.
...
**iOS 17+, iPadOS 17+, macOS 14+, ios-visionOS 1.0+**
...
**Related References**: `references/deep/layout.md`, `references/deep/debugging.md`
