...
These patterns use NWConnection with completion handlers for apps supporting iOS 12-25. If your app targets iOS 26+, use NetworkConnection with async/await instead (see `ios-networking.md`).
...
- See Pattern 1d in [ios-networking--REFERENCES.md](ios-networking--REFERENCES.md)

---

Return to [main networking reference](ios-networking.md).
