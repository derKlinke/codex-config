...
**For migrations** See the Migration section in this skill for VersionedSchema and SchemaMigrationPlan patterns, plus the Troubleshooting section for migration debugging.
...
**Skills**: swiftdata, grdb, swift-concurrency-expert
