...
For apps supporting iOS 12-25 that can't use async/await yet, see [LEGACY-IOS12-25.md](ios-networking--LEGACY-IOS12-25.md):
...
For detailed migration guides from legacy networking APIs, see [MIGRATION.md](ios-networking--MIGRATION.md):
...
For detailed WWDC session descriptions, Apple documentation links, and related skills, see [REFERENCES.md](ios-networking--REFERENCES.md).
