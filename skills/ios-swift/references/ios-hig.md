...
- Use `swiftui-liquid-glass` for iOS 26 Liquid Glass implementation guidance
- Use `swiftui-26-ref` for design system changes across platforms
- Use `typography-ref` for typography rules and Dynamic Type specifics
...
[Show the relevant HIG section from this skill]
...
- `swiftui-liquid-glass` — iOS 26 Liquid Glass implementation guidance
- `swiftui-26-ref` — SwiftUI 26 design system changes
- `typography-ref` — Typography, Dynamic Type, and text metrics
