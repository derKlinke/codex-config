...
- **First step optimization** — Profile with Instruments before touching code
- **SwiftUI performance** — Use `swiftui-performance` skill instead
- **Build time optimization** — Out of scope here (compile-time optimization is separate)
...
**Skills**: swiftui-performance, swift-concurrency-expert, xcode-debugging
