...
- `ios-core-location` — Anti-patterns, decision trees, pressure scenarios
- `ios-core-location-diag` — Symptom-based troubleshooting
- `ios-energy-ref` — Location as battery subsystem (accuracy vs power)
...
**Skills**: ios-core-location, ios-core-location-diag, ios-energy-ref
