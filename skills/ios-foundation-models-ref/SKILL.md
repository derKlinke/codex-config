...
**Related Skills**:
- `ios-foundation-models` — Discipline skill with anti-patterns, pressure scenarios, decision trees
- `ios-foundation-models-diag` — Diagnostic skill for troubleshooting issues
...
Use `@Generable` with `respond(to:generating:)` instead of prompting for JSON and parsing manually. See `ios-foundation-models` Scenario 2 for the complete migration pattern.
...
**Skills**: ios-foundation-models, ios-foundation-models-diag
