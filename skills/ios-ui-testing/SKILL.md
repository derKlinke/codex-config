...
**Supported Platforms**: iOS, iPadOS, macOS, watchOS, tvOS, ios-visionOS (Designed for iPad)
...
- Setting system state (Dark Mode, ios-localization, etc.)
...
**For deep crash analysis**: See `ios-swift-concurrency` skill for @MainActor patterns and `ios-memory-debugging` skill for thread-safety issues.
