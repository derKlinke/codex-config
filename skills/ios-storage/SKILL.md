...
- SwiftData implementation details (use `ios-swiftdata` skill)
- SQLite/GRDB specifics (use `ios-sqlitedata` or `ios-grdb` skills)
- CloudKit sync implementation (use `ios-cloudkit-ref` skill)
- File protection APIs (use `ios-file-protection-ref` skill)

**Related Skills**:
- Existing database skills: `ios-swiftdata`, `ios-sqlitedata`, `ios-grdb`
- New file skills: `ios-file-protection-ref`, `ios-storage-management-ref`, `ios-storage-diag`
- New cloud skills: `ios-cloudkit-ref`, `ios-icloud-drive-ref`, `ios-cloud-sync-diag`
...
- **Use skill**: `ios-swiftdata` for implementation details
...
- **Use skill**: `ios-sqlitedata` for modern SQLite patterns

**Use GRDB when**:
- Need reactive queries (ValueObservation)
- Complex database operations
- Type-safe query builders
- **Use skill**: `ios-grdb` for advanced patterns
...
**Use skill**: `ios-file-protection-ref` for encryption options
...
**Use skill**: `ios-storage-management-ref` for purge policies and disk space management
...
1. **SwiftData + CloudKit** (Recommended, iOS 17+):
   ...
   - Easiest approach
   - **Use skill**: `ios-swiftdata` for details
...
**Use skill**: `ios-icloud-drive-ref` for implementation details
...
|-----------|--------|----------------|------------|-----------|
| User tasks, notes | Structured | Application Support | SwiftData + CloudKit | `ios-swiftdata` → `ios-cloudkit-ref` |
| User photos (created) | File | Documents | iCloud Drive | `ios-file-protection-ref` → `ios-icloud-drive-ref` |
| Downloaded images | File | Caches | None (re-download) | `ios-storage-management-ref` |
| Thumbnails | File | Caches | None (regenerate) | `ios-storage-management-ref` |
| Database file | File | Application Support | CKSyncEngine (if custom) | `ios-sqlitedata` → `ios-cloudkit-ref` |
