...
**Related skills**: `xcode-debugging` (cache corruption diagnosis), `swift-concurrency-expert` (observer patterns), `swiftui-performance` (profiling with Instruments), `swiftui-layout` (adaptive layout patterns)
...
#### Use `swift-concurrency-expert` instead when
...
**Skills**: swiftui-performance, xcode-debugging, swift-concurrency-expert
