...
license: MIT
compatibility: iOS 11+, iPadOS 11+, macOS 10.13+, tvOS 11+, ios-visionOS 1+
metadata:
  version: "1.1.0"
...
**Prevention**: Check API availability in `ios-vision-ref` before implementing
...
// ❌ WRONG (no Y flip)
let uiPoint = CGPoint(
    x: ios-visionPoint.x * width,
    y: ios-visionPoint.y * height
)
...
**Skills**: ios-vision, ios-vision-ref
