...
Use your existing simulator test workflow for multi-step navigation/state validation.
...
**Pro tip**: If you have debug deep links (see `ios-deep-link-debugging` skill), you can navigate directly to the screen that was broken:
```bash
