...
For state restoration, advanced URL routing, and tab-based coordination, see `ios-swiftui-nav` — Pattern 7 (Coordinator) for structure, Pattern 1b for URL-based deep linking.
...
**Platforms**: iOS 26+, iPadOS 26+, macOS Tahoe+, watchOS 26+, ios-visionOS 26+
**Xcode**: 26+
