...
For CarPlay-specific integration patterns, invoke `/skill ios-now-playing-carplay`.
...
For MusicKit-specific integration patterns and hybrid app examples, invoke `/skill ios-now-playing-musickit`.
...
**Skills**: ios-avfoundation-ref, ios-now-playing-carplay, ios-now-playing-musickit
