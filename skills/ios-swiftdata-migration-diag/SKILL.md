---
name: ios-swiftdata-migration-diag
...
- You need two-stage migration (covered in `ios-swiftdata-migration` skill)
...
**Skills**: ios-swiftdata-migration, ios-swiftdata, ios-database-migration
