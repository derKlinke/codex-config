---
name: ios-storage-management-ref
...
Set encryption level per file. See `ios-file-protection-ref` for full guide.
...
- `ios-storage` — Decide where to store files
- `ios-file-protection-ref` — File encryption and security
- `ios-storage-diag` — Debug storage-related issues
