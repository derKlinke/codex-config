---
name: ios-foundation-models-diag
...
**Related iOS Skill Pack Skills**:
- `ios-foundation-models` — Discipline skill for anti-patterns, proper usage patterns, pressure scenarios
- `ios-foundation-models-ref` — Complete API reference with all WWDC 2025 code examples
